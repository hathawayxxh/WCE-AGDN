"""
This script performs the ablation study that evaluates the effectiveness of the deformable conv in TLFA module.
Replace the deformale convolution in TLFA modules with pointwise convolution,
we call the new module TLFA- (name used in the paper) or second-order non-local (SONA) modules (name used in this script).
The comparison results are shown in TABLE III and Fig. 6 of the paper.
"""
...
class DenseNet:
    ...
    def save_path(self):
        try:
            ...
            save_path = 'saves/B2_1SONA/' + self.which_split
    ...
    def network(self, _input):
        ...
        for block in range(self.total_blocks):
            ...
            # if block == 3:
            #     output = self.SONA(output, int(output.shape[-1]), de=4, scope='SONA4', trainable=True, reuse=False)
    ...
    def train_all_epochs(self, train_params):
        ...
        try:
            ...
            dataframe.to_csv("./acc_results/B2_2SONA/" + self.which_split + ".csv", index=True, sep=',')
    ...
    def test(self, batch_size):
        ...
        saliency_path = "./visualize_heatmaps/B2_1SONA"
        ...
        for i in range(self.num_test // batch_size):
            ...
            for index in range(batch_size):
                ...
                if labels[index] != 0:
                    ...
                    # save_img(input2[index], img_index, input_path, img_name = '_input2.jpg', split=self.which_split, mode = "image")

                    save_img(s_map1[index], img_index, saliency_path, img_name = '.jpg', split=self.which_split, mode = "heatmap")
