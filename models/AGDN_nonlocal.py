"""
This script replaces the 3 TLFA modules in the AGDN model with nonlocal modules.
The comparison results between TLFA and nonlocal modules are shown in TABLE III and Fig. 6 of the paper.
"""
