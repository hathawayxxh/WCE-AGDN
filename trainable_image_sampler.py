"""
This script operates image sampling using the combination of LTZ and structured_LTZ.
sampling_grids = lamda * LTZ_grids + (1-lamda) * structured_grids.
When lamda = 1, it can be considered as LTZ sampling,
when lamda = 0, it can be considered as structured_LTZ sampling,
"""
import cv2
import numpy as np
